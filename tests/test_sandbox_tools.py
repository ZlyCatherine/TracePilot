...
from tracepilot.core.tools.sandbox_tools import (
    list_office_files,
    read_office_file,
    write_office_file,
...
from tracepilot.core.config import OFFICE_DIR
...
class TestSandboxTools(unittest.TestCase):
    ...
    @patch('tracepilot.core.tools.sandbox_tools.os.path.exists', return_value=True)
    @patch('tracepilot.core.tools.sandbox_tools.os.listdir', return_value=['file1.txt', 'subdir'])
    @patch('tracepilot.core.tools.sandbox_tools.os.path.isdir', side_effect=lambda x: x.endswith('subdir'))
    ...
    @patch('tracepilot.core.tools.sandbox_tools.os.path.exists', return_value=False)
    ...
    @patch('tracepilot.core.tools.sandbox_tools.subprocess.run')
