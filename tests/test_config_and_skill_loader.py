...
class TestConfig(unittest.TestCase):
    ...
    def test_config_import(self):
        """测试配置模块导入"""
        from tracepilot.core.config import WORKSPACE_DIR, MEMORY_DIR, PERSONAS_DIR, SCRIPTS_DIR, OFFICE_DIR, SKILLS_DIR, DB_PATH, TASKS_FILE
...
class TestSkillLoader(unittest.TestCase):
    ...
    def test_skill_loader_import(self):
        """测试技能加载器模块导入"""
        try:
            from tracepilot.core.skill_loader import load_dynamic_skills
            # 确保函数存在
