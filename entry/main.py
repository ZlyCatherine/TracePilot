...
from tracepilot.core.config import DB_PATH
from tracepilot.core.bus import task_queue
from tracepilot.core.heartbeat import pacemaker_loop
from tracepilot.core.mcp_client import shutdown_mcp_runtime
...
{RESET}"""
    ...
    sub_title = f"{WHITE}{BOLD} 👾 Welcome to the {PURPLE}{BOLD}TracePilot{RESET}{WHITE}{BOLD} !  {RESET}"
    ...
    tip = (
        f"{PURPLE} ✦ {RESET}"
        f"{SILVER}{PURPLE}{BOLD}TracePilot{RESET} 已完成启动。输入命令开始，输入 {PURPLE}/exit{RESET}{SILVER} 退出。{RESET}\n"
    )
...
async def async_main():
    ...
    async with AsyncSqliteSaver.from_conn_string(DB_PATH) as memory:
        ...
        def get_bottom_toolbar():
            ...
            return ANSI(
                f"  \033[38;5;51m{frame}\033[0m \033[38;5;250m{display_msg}\033[0m \033[38;5;141m[{elapsed:.1f}s]\033[0m")
        ...
        async def user_input_loop():
            ...
            while True:
                try:
                    ...
                    if user_input.lower() in ["/exit", "/quit"]:
                        cprint("  \033[38;5;141m✦ 记忆已固化，TracePilot 进入休眠。\033[0m")
                        break

                except (KeyboardInterrupt, EOFError):
                    cprint("\n  \033[38;5;141m✦ 强制中断，TracePilot 进入休眠。\033[0m")
